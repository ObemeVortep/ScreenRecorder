...
#include "AUDIO_WORKER_CONTROLLER/AudioWorkerController.h"
...
private:
	...
	// AudioWorkerController continuosly records audio and encode it into AAC format
	AudioWorkerController sysAudioWorkerController;
};
